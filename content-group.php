	  ...
	  <section id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<article>
		  ...
		  <div class="entry-content clearfix">
			...
			<?php
			$host_location = get_post_meta( $host['ID'], '_user_postal_code', true );
			$location_string = '';
			...
			<div>
				<div class="archive-avatar">
				  ...
				  <p>
					<div><a href="<?php echo get_permalink( $host['ID'] ); ?>"><?php echo $host['post_title']; ?></a></div>
					...
					<div class="host-location">
						<span class="dashicons dashicons-location-alt"></span><?php echo $location_string; ?>
					</div>
					<?php endif; ?>
				  </p>
				</div>
